    ...
    <div className="flex md:flex-row flex-col justify-center items-center h-screen">
      <div className="">
        <Image
          ...
          height={1000}
          alt="model"
          className="w-2/5 mt-16 m-auto md:w-11/12  rounded-full border-2 border-t-0 border-l-0 border-white shadow-xl"
        />
      </div>
      <div className="md:w-2/4 w-full ">
        <p className="font-bold text-2xl m-4 text-center md:text-start">Our Values to Help You</p>
        <div className="flex flex-wrap justify-center">
          <div className="shadow-xl rounded-xl mx-4 border-b-2 border-b-[#420a6c] w-fit">
